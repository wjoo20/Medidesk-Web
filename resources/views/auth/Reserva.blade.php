  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name">Jhon</p>
          <p class="app-sidebar__user-designation">admision</p>
        </div>
      </div>
      <ul class="app-menu">
    ...
    <main class="app-content">
      ...
      <div class="tile-footer">
        <button class="btn btn-primary" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Confirmar Reserva</button>
      </div>
    </main>
