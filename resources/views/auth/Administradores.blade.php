  ...
  <body class="app sidebar-mini">
   ...
   {{ __('Logout') }}
    ...
    <aside class="app-sidebar">
      ...
      <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="/administradores"><i class="icon fa fa-circle-o"></i> Administradores</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Administradores</h1>
          <p>En esta sección se visualizarán los administradores registrados.</p>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/administradores/actualizar">
                            @csrf
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody> 
                    ...
                    @foreach ($adm as $a)
                      ...
                      <td><a class="btn btn-success" href="/administradores/actualizar?id={{$a->dni}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Editar</a>
                      <a class="btn btn-danger" href="/administradores/eliminar?id={{$a->dni}}" onclick="return confirm('Está seguro que desea eliminar?. Recuerde que se eliminarán todos los datos del usuario.')"><i class="fa fa-fw fa-lg fa-times-circle"></i>Eliminar</a></td>
